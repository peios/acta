...
var pages = func() map[string]*template.Template {
	...
	for _, name := range []string{"login.html", "board.html", "security.html", "workspaces.html", "welcome.html", "archive.html", "agents.html", "agent_detail.html", "cli_authorize.html"} {
